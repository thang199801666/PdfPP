...
public:
    explicit PdfFilterPipeline(
        std::size_t maxDecodedSize = 512ULL * 1024ULL * 1024ULL,
        std::size_t maxExpansionRatio = 10'000U)
        : maxDecodedSize_(maxDecodedSize), maxExpansionRatio_(maxExpansionRatio) {}
