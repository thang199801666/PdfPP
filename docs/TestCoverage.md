...
| Advanced annotations (FreeText/Ink/Polygon/Polyline/Square/Circle/Stamp) | `API.AdvancedAnnotationsAndXfdf` | Add, remove (filtered and full), update contents, appearance generation, and XFDF export/import round trip |
